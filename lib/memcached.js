...
(function (nMemcached) {
  ...
  //add JSON date parsing
  if (typeof JSON.dateParse === 'undefined')
  {
    ...
    if (Object.defineProperty) {
      try {
        Object.defineProperty(JSON, 'dateParse', {
          value: dateParse, configurable: true, enumerable: false, writable: true
        });
      } catch(e) {}
    }
    else {
      JSON.dateParse = dateParse;
    }
  }
  ...
  , 'VALUE': function value(tokens, dataSet, err, queue) {
      ...
      switch (flag) {
        case FLAG_JSON:
          dataSet = JSON.parse(dataSet, JSON.dateParse);
          break;
        case FLAG_NUMERIC:
          dataSet = +dataSet;
          break;
